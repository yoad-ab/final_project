...
from .logger_manager import setup_logger, write_run_header, log_event,log_error, end_run
...
def run_pipeline(selected_analyses, experiment_id: str, data_id: str):
    ...
    write_run_header(
        ...
        analysis_name=recipe.recipe_id
    )
